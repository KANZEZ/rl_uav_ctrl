...
a Python wrapper for a fast solver generated by FORCESPRO v6.3.0
   ...
   subject to the parameters supplied in the following dictionary:
       PARAMS['xinit'] - matrix of size [13x1]
       PARAMS['x0'] - matrix of size [51x1]

   OUTPUT returns the values of the last iteration of the solver where
       OUTPUT['x1'] - column vector of length 17
       OUTPUT['x2'] - column vector of length 17
       OUTPUT['x3'] - column vector of length 17
...
#    def from_param(self):
#        return self
    _fields_ = [('xinit', ctypes.c_double * 13),
('x0', ctypes.c_double * 51),
]
...
#    def from_param(self):
#        return self
    _fields_ = [('x1', ctypes.c_double * 17),
('x2', ctypes.c_double * 17),
('x3', ctypes.c_double * 17),
]

FORCESNLPsolver_outputs = {'x1' : np.array([]),
'x2' : np.array([]),
'x3' : np.array([]),
}
