classdef CodeGen1
    % CodeGen1   A client to connect to the CodeGen service
    %    SERVICE = CodeGen1  connects to https://forces.embotech.com/CodeGen.asmx and returns a SERVICE.
    %    
    %    To communicate with the service, call a function on the SERVICE:
    %
    %       [...] = FUNCTION(SERVICE,arg,...) 
    %
    %    See <a href="matlab:doc CodeGen1">doc CodeGen1</a> for a list of functions.
         
    % This file generated by matlab.wsdl.createWSDLClient at 19-Sep-2023 10:14:52
            ...
            try
                ...
                if strcmp(e.identifier,'MATLAB:undefinedVarOrClass')
                    ...
                    if ~any(cellfun(@(x)jpath.equals(java.io.File(x).getCanonicalFile), cp))
                        ...
                        error(message('MATLAB:webservices:AddClasspath', 'CodeGen1', thePath, thePath));
                    else
