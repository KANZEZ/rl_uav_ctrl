...
solver_int32_default EVAL_FUN_NAME(SOLVER_FLOAT *x, SOLVER_FLOAT *y, SOLVER_FLOAT *l,
...
int INTERFACE_FUN_NAME(void *params, void *outputs, void *info, void *mem, FILE *fp) {
    return SOLVER_FUN_NAME(params, outputs, info, mem, fp, &EVAL_FUN_NAME);
}
