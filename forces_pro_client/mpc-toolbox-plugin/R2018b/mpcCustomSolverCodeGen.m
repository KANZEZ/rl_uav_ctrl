...
params = struct('H', H, 'f', f, 'A', -A, 'b', -b, 'x0', x0);
[output,exitflag,SolverInfo] = customForcesDenseQPBuildable.forcesCallWithParams(params);
[x, status] = mpcForcesToCustomSolver(output, exitflag, SolverInfo, x0);
