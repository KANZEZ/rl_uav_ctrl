...
%
%     onlinedata:   a structure containing Plant and Nominal structs in
%                   addition to signals such as references, measured outputs, 
%                   external MV, online constraints, online weights, etc.
%
%   Outputs:
%
...
%                   Cost: optimal cost
%
%  The following linear MPC features are supported when using the FORCESPRO QP
%  solver:  
%
...
%
% See also mpcToForces, mpcToForcesOptions, mpcmoveForces.
