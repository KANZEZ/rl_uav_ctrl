...
%
%   [mv, statedata, info] = mpcmove_engineForces(coredata, statedata, onlinedata, dynamics, offsets, gains)
%
%   Inputs:
%
...
%                   online weights, etc.
%
%       dynamics:   a structure containing the updated (scaled) plant model 
%                   A, B, C, D, Bmv, Bmd, Bdx, Cm, Dmd, Dmdm, Ddxm
%
%        offsets:   a structure containing the (scaled) nominal offsets: 
%                   NominalX, ScaledNominalU, ScaledNominalY, NominalDX. It 
%                   is generated by "mpcmoveForces" or 
%                   "mpcmoveAdaptiveForces" and is used as a constant here.
%
%          gains:   a structure containing the kalman gains L and M. It is
%                   generated by "mpcmoveForces" or "mpcmoveAdaptiveForces 
%                   and is used as a constant here.
%
%   Outputs:
%
...
%
% See also mpcmoveForces, mpcmoveAdaptiveForces, mpcToForces, mpcToForcesOptions.
