"""
Python client for FORCESPRO
For more details see https://forces.embotech.com/Documentation/

This module loads the Python client for the FORCESPRO code generator.
