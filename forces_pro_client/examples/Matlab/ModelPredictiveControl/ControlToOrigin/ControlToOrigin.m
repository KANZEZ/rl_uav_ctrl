...
% (c) Embotech AG, Zurich, Switzerland, 2016.
    ...
    % system:
    objective.computeTerminalCost = true; % switch to true for LQR terminal cost
    controller = SimpleRegulationMPC(system, objective, constraints, N, 'ControlToOrigin_solver');
