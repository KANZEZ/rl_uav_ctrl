function [] = ObstacleAvoidance_ownFevals()
...
% (c) Embotech AG, Zurich, Switzerland, 2013-2023.
    ...
    [output,exitflag,info] = FORCESNLPsolver(problem); %#ok<ASGLU>
...
% planning problem by calling the FORCESPRO code generation.
    ...
    model.bfgs_init = 3.000 * eye(7); % set initialization of the 
