...
% 
% See also FORCES_NLP PathTracking
% 
% (c) Embotech AG, Zurich, Switzerland, 2013-2023.
    ...
    model.bfgs_init=2.5*eye(7); % initialization of the 
...
function [ result ] = rad2deg(rad)
    result = rad/pi*180; % convert radians into degrees
end

function [ result ] = deg2rad(deg)
    result = deg/180*pi; % convert degrees into radians
end
