function [Y, U, exitflags, solvetimes] = simulateMpcForces(mpcObj, disPlant, simLength, xinit, yref, measOutId, coredata, statedata, onlinedata, uref)
...
% (c) Embotech AG, Zurich, Switzerland, 2019-2023.
    ...
    exitflags  = zeros(1, simLength);
    solvetimes = zeros(1, simLength);
    ...
    for t = 1:simLength
        ...
        exitflags(t) = info.ExitFlag;
        solvetimes(t) = info.SolveTime;
    end
