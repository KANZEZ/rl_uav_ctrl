...
%       used for the simulation.
    ...
    forcesOptions.ForcesMaxIteration = 200;
    forcesOptions.ForcesServer = 'https://forces.embotech.com';
    ...
    codegen('-config',Cfg,mfunName,'-o',mexfunName,'-args',{coder.Constant(forcesCoredata), forcesStatedata, forcesOnlinedata}, '-nargout', 3);
