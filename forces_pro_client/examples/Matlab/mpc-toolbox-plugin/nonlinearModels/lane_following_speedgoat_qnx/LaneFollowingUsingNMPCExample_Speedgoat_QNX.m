...
%% and the FORCESPRO nlmpc plugin running on a Speedgoat QNX hardware
...
mdl = 'LaneFollowingNMPC_Speedgoat_QNX';
...
% Choose Speedgoat QNX platform to run FORCESPRO solver
options.ForcesTargetPlatform = 'Speedgoat-QNX';
...
%% 
% Start code generation for Speedgoat QNX
