classdef RocketAnimation < handle
    ...
    methods
        ...
        function this = RocketAnimation(numstates,numactions)
            ...
            addParameter(p,'FigureName','rlVisualizer',validName);
    ...
    methods (Access = protected)
        ...
        function f = buildFigure(this)
            ...
            % Add tab group
            tabgp = uitabgroup(f,'Tag','tabgp');
            
            % Add animation tab
            tab_anim = uitab(tabgp,'Title','Animation','Tag','tab_anim');
            ax_anim = axes(tab_anim,'Tag','ax_anim','NextPlot','add'); % NextPlot or hold on removes the issue of Tag disappearing
            uicontrol(tab_anim,'Style','togglebutton',...
                'Tag','btn_anim',...
                'Value',1,...
                ...
                'Callback',@(src,event)animBtnpushed(src,event,this));
