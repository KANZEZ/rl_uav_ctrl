...
% see https://www.mathworks.com/help/mpc/ug/landing-rocket-with-mpc-example.html
    ...
    [coredata, onlinedata, model] = nlmpcMultistageToForces(planner, options); %#ok<ASGLU>
    ...
    tic;
    [~, ~, infoFORCES] = nlmpcmove_myForcesNLPSolver(x0,u0,onlinedata);
    tFORCES = toc;
