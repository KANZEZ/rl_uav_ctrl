...
# evaluation etc. See the example file "obstacle_avoidance_own_feval.py" for 
# how to pass custom C functions to FORCES.
# --------------------------------------------------------------------------
...
def generate_pathplanner():
    ...
    model.ineq = lambda z,p:  casadi.vertcat(z[2] ** 2 + z[3] ** 2,
                                    (z[2] -p[0]) ** 2 + (z[3] - p[1]) ** 2)
