...
# assume variable ordering z[i-1] = [ui, x_i+1] for i=1...N-1
stages = forcespro.MultistageProblem(N-1)
for i in range(N-1):
...
stages.newParam('minusA_times_x0', [1], 'eq.c')  # RHS of first eq. constr. is a parameter: c1 = -A*x0
...
stages.codeoptions['solvemethod'] = 'ADMM'
stages.codeoptions['ADMMrho'] = 6
stages.codeoptions['ADMMfactorize'] = 1
